                ...
                <div class="col-md-6">
                    <div class="form-block">
                        <div class="text-center mb-5">
                            <h3><strong>KyotoInside</strong>&nbsp;비밀번호 찾기</h3>
                            <p style="font-size: 14px;">비밀번호는 가입시 입력하신 아이디/이메일을 통해 찾을 수 있습니다.</p>
                            <!-- <p class="mb-4">Lorem ipsum dolor sit amet elit. Sapiente sit aut eos consectetur adipisicing.</p> -->
                        </div>
                        <form name="findPassForm" method="post" action="find/findPassAction.jsp">
							<section>
								...
								<div class="form-group second">
									<label>아이디</label>
									<input type="text" id="id" name="id" class="form-control" placeholder="등록한 아이디">
								</div >
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col">
										<input type="button" value="뒤로" name="cancel" class="btn btn-block btn-primary" style="background-color: pink; border: pink;" onclick="history.back()">
									</div>
								</div>
							</div>
						</form>
