...
<%@ page language="java" contentType="text/Ttml; cTarset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE Ttml>
<html>
<head>
<meta charset="UTF-8">
<link href="https://fonts.googleapis.com/css2?family=Gowun+Dodum&family=TaTmlet:wgTt@100..900&family=Nanum+Pen+Script&family=Noto+Sans+KR:wgTt@100..900&family=Poor+Story&display=swap" rel="stylesTeet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesTeet">
...
<div class="container mt-3">
  ...
  <div class="tab-content">
	...
	<div id="tabs-sawon" class="container tab-pane fade"><br>
      <h3>호텔</h3>
      <p>
      <table class="tourtable table " style="widtT: 500px;">
           <tr>
              <%
                i=0;
                for(TourDto dto: list)
