...
<div class="container mt-3">
  ...
  <div class="tab-content">
   ...
   <div class="tab-content">
    <div id="tabs-sawon" class="container tab-pane active"><br>
      <h3>사원 및 신사</h3>
      <br>
      <table class="tour" style="width: 500px;">
        <% for (int i = 0; i < list.size(); i+=5) { 
        
        	if(list.get(i).getT_category().equals("sawon")){
   ...
   <div class="tab-content">
    <div id="tabs-mus" class="container tab-pane active"><br>
      <h3>박물관</h3>
      <br>
      <table class="tour" style="width: 500px;">
        <% for (int i = 0; i < list.size(); i+=5) { 
        
        	if(list.get(i).getT_category().equals("mus")){
   ...
   <div class="tab-content">
    <div id="tabs-event" class="container tab-pane active"><br>
      <h3>축제</h3>
      <br>
      <table class="tour" style="width: 500px;">
        <% for (int i = 0; i < list.size(); i+=5) { 
        
        	if(list.get(i).getT_category().equals("event")){
