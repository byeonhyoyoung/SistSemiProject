...
<body>
	...
	<div class="btnlog">
		...
		<a href="index.jsp?main=login/loginForm3.jsp"><i
			class="bi bi-door-open fs-2"></i></a> <a
			href="index.jsp?main=member/addform2.jsp"><i
			class="bi bi-person-plus fs-2"></i></a>
		<%}else{%>
		<!--lmy: 로그인한 상태에서 마이페이지로 넘어감! -->
		<a href="index.jsp?main=member/mypage.jsp">마이페이지</a> <b
			style="font-size: 15pt; color: gray;"><%=name %>님 로그인상태..</b> <a
			href="login/logoutAction.jsp"><i
			class="bi bi-door-open-fill fs-2"></i></a>
