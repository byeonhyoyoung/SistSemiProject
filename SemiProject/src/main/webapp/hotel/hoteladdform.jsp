...
<div style="margin: 50px 100px; width: 600px;">
    <form id="hotelForm" action="hotel/hoteladdaction.jsp" method="post" enctype="multipart/form-data">
       <table class="table table-bordered">
          <caption align="top"><b>숙박시설등록</b></caption>
          
          <tr>
             <td style="width: 150px;" class="table-light"><b>영어 이름</b></td>
             <td>
               <input type="text" name="h_subject" class="form-control"
          ...
          <tr>
             ...
             <td>
               ...
               style="width: 200px;" required="required" placeholder="한글 이름 작성">
             </td>
          </tr>
          ...
          <tr>
           ...
           <tr>
              ...
              required="required" name="h_category">
                 <option value="hotel" selected="selected">호텔</option>
           ...
           <tr>
             ...
             <td>
               <input type="text" name="h_googlemap" class="form-control"
          ...
          <tr>
            <td colspan="2" align="center">
              ...
              style="width: 100px; background-color: #eeeeee; border: #eeeeee;" onclick="location.href='index.jsp?main=hotel/hotelmain.jsp'">식당목록</button>
            </td>
          </tr>
       </table>
    </form>
